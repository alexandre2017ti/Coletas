...
- [x] Envio das mudanças locais e acompanhamento do workflow GitHub — quatro commits enviados em 22/09; workflow nº 8 falhou no mobile por patch do Expo e o workflow nº 9 aprovou os seis jobs. Registros: [patch do Expo](mudancas/2026-09-22-01-atualizar-patch-expo.md) e [resultado](mudancas/2026-09-22-02-workflow-verde.md).
